...
function vue_slider_dot_typeof(obj) { "@babel/helpers - typeof"; if (typeof Symbol === "function" && typeof Symbol.iterator === "symbol") { vue_slider_dot_typeof = function _typeof(obj) { return typeof obj; }; } else { vue_slider_dot_typeof = function _typeof(obj) { return obj && typeof Symbol === "function" && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }; } return vue_slider_dot_typeof(obj); }
...
function _possibleConstructorReturn(self, call) { if (call && (vue_slider_dot_typeof(call) === "object" || typeof call === "function")) { return call; } return _assertThisInitialized(self); }
...
function _objectSpread(target) { for (var i = 1; i < arguments.length; i++) { var source = arguments[i] != null ? arguments[i] : {}; if (i % 2) { ownKeys(Object(source), true).forEach(function (key) { control_defineProperty(target, key, source[key]); }); } else if (Object.getOwnPropertyDescriptors) { Object.defineProperties(target, Object.getOwnPropertyDescriptors(source)); } else { ownKeys(Object(source)).forEach(function (key) { Object.defineProperty(target, key, Object.getOwnPropertyDescriptor(source, key)); }); } } return target; }
...
function control_toConsumableArray(arr) { return control_arrayWithoutHoles(arr) || control_iterableToArray(arr) || _unsupportedIterableToArray(arr) || control_nonIterableSpread(); }
...
function control_arrayWithoutHoles(arr) { if (Array.isArray(arr)) return _arrayLikeToArray(arr); }
...
var control_Control = /*#__PURE__*/function () {
  ...
  control_createClass(Control, [{
    ...
    value: function setValue(value) {
      ...
      this.setDotsValue(Array.isArray(value) ? this.order ? control_toConsumableArray(value).sort(function (a, b) {
        return _this.getIndexByValue(a) - _this.getIndexByValue(b);
      }) : control_toConsumableArray(value) : [value], true);
    }
  }, {
    key: "setDotsValue",
...
vue_slider_VueSlider = __decorate([vue_class_component_esm({
  data: function data() {
    return {
      control: null
    };
