          ...
          vue_slider_createClass(VueSlider, [
            ...
            },
            {
              ...
              value: function setScale() {
                var decimal = new Decimal(
                  Math.floor(
                    this.isHorizontal ? this.$refs.rail.offsetWidth : this.$refs.rail.offsetHeight,
                  ),
                )
            ...
            },
            {
              ...
              value: function getPosByEvent(e) {
                return (
                  getPos(e, this.$refs.rail, this.isReverse)[this.isHorizontal ? 'x' : 'y'] /
                  this.scale
                )
              },
            },
